 ...
 */
define(["jquery",
    "/lib/artDialog/6.0.2/src/popup.js",
    "/lib/artDialog/6.0.2/src/dialog-config.js",
    "css!/lib/artDialog/6.0.2/css/ui-dialog.css"
], function ($, Popup, defaults) {
...
artDialog.create = function (options) {
    ...
    this.addEventListener('remove', function () {
        $(this.backdrop).stop(true);     //清空动画效果，否则会出现内存泄漏 add by 2014.11.08
        $(this.backdrop).clearQueue();     //清空动画效果，否则会出现内存泄漏 add by 2014.11.08
        $(this.backdrop).off('onmousedown' in document ? 'mousedown' : 'click');  //add by 2014.11.07
