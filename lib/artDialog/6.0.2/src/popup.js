...
$.extend(Popup.prototype, {
    ...
    remove: function () {
        ...
        if(this.__backdrop){
            this.__backdrop.stop(true);     //清空动画效果，否则会出现内存泄漏 add by 2014.11.08
            this.__backdrop.clearQueue();     //清空动画效果，否则会出现内存泄漏 add by 2014.11.08
            this.__backdrop.off();            //销毁事件  add by 2014.11.07
            this.__backdrop.remove();
            this.__backdrop = null;      //消除引用  add by 2014.10.28
            delete this.__backdrop;
        }
        ...
        this.__popup = null;        //消除引用  add by 2014.10.28
        this.node = null;              //消除引用  add by 2014.10.28
    ...
    __unlock: function () {
        ...
        if (this.modal) {
            ...
            this.__backdrop.remove();
            this.__backdrop = null;           //消除引用  add by 2014.10.28
            delete this.__backdrop;     //删除属性 add by 2014.10.28
            delete this.modal;
        }
    }
