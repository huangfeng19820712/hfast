 ...
 * 修改：
 * 1.原来td只能包含input，改成可以包含div
 * 2.resize的时候setGridWidth扣减去边框
            ...
            var sortkeys = ["shiftKey","altKey","ctrlKey"],
                ...
                buildColItems = function (top, left, parent) {
                    var cm = ts.p.colModel, len = cm.length, i, cols=[], disp,
                        ...
                        //去掉top的值，偏移太大
                        str1 = '<ul id="col_menu" class="ui-search-menu  ui-col-menu modal-content" role="menu" tabindex="0" style="left:'+left+'px;top:-5px;">';
                    for(i=0;i<len;i++) {
                ...
                buildSearchBox = function (index, top, left, parent) {
                    ...
                    //bug 偏移太大，改成top=-5
                    elem = $('<ul id="search_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="left:'+left+'px;top:-5px;"></ul>').append(elem);
                    $(parent).append(elem);
    ...
    $.jgrid.extend({
        ...
        setGridWidth : function(nwidth, shrink) {
            return this.each(function(){
                ...
                $("#gview_"+$.jgrid.jqID($t.p.id)).css("width",(nwidth - bstw)+"px");
                    ...
                    triggerToolbar = function() {
                        ...
                        $.each($t.p.colModel,function(){
                            ...
                            if(p.searchOperators &&  sop.searchOperMenu) {
                                ...
                                //1.原来td只能包含input，改成可以包含div
                                so = $elem.closest("td").prev().children("a").attr("soper") || p.defaultSearch;
                            } else {
